...
#if 0 // defined(CONFIG_SND_OMAP_SOC_OPENITY_GEMALTO)
		/* !!!  This is a hack! Not all RIGHT_J's will do this.  !!!
		 * Gemalto framesize is fixed at 32 bits, even with only 1 chan, force it.
...
#if defined(CONFIG_SND_OMAP_SOC_OPENITY_GEMALTO)
