...
static struct gpio hd1u_gpios[] __initdata = {
	...
	\
	{ HD1U__O_SYS_ERROR, GPIOF_OUT_INIT_LOW, "HD1U__O_SYS_ERROR" },
	\
	...
	\
	{ HD1U__O_RM1_IGNITION, GPIOF_OUT_INIT_HIGH, "HD1U__O_RM1_IGNITION" },
	...
	\
	{ HD1U__O_RM2_IGNITION, GPIOF_OUT_INIT_HIGH, "HD1U__O_RM2_IGNITION" },
	...
	\
	{ HD1U__O_RM3_IGNITION, GPIOF_OUT_INIT_HIGH, "HD1U__O_RM3_IGNITION" },
	...
	\
	{ HD1U__O_RM4_IGNITION, GPIOF_OUT_INIT_HIGH, "HD1U__O_RM4_IGNITION" },
...
static void __init hd1u_gpios_init(void)
{
	...
	// status led outputs
	if ( gpio_export(HD1U__O_SYS_ERROR, 0) < 0 )
	{
		printk(KERN_ERR "gpio failed to export 'HD1U__O_SYS_ERROR'\n");
		return;
	}
